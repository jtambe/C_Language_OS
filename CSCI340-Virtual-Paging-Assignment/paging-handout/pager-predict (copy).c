...
FILE *fp;
fp = fopen("./procAnalysis/AllProcs.txt","a");
fprintf(fp,"proc = %d , pc = %d, page = %d \n", proctmp, pc, page);
fclose(fp);
if(proctmp == 0)
{
  fp = fopen("./procAnalysis/proc0.txt","a");
  fprintf(fp,"proc = %d , pc = %d, page = %d \n", proctmp, pc, page);
  fclose(fp);
}
if(proctmp == 1)
{
  fp = fopen("./procAnalysis/proc1.txt","a");
  fprintf(fp,"proc = %d , pc = %d, page = %d \n", proctmp, pc, page);
  fclose(fp);
}
if(proctmp == 2)
{
  fp = fopen("./procAnalysis/proc2.txt","a");
  fprintf(fp,"proc = %d , pc = %d, page = %d \n", proctmp, pc, page);
  fclose(fp);
}
if(proctmp == 3)
{
  fp = fopen("./procAnalysis/proc3.txt","a");
  fprintf(fp,"proc = %d , pc = %d, page = %d \n", proctmp, pc, page);
  fclose(fp);
}
if(proctmp == 4)
{
  fp = fopen("./procAnalysis/proc4.txt","a");
  fprintf(fp,"proc = %d , pc = %d, page = %d \n", proctmp, pc, page);
  fclose(fp);
}
if(proctmp == 5)
{
  fp = fopen("./procAnalysis/proc5.txt","a");
  fprintf(fp,"proc = %d , pc = %d, page = %d \n", proctmp, pc, page);
  fclose(fp);
}
if(proctmp == 6)
{
  fp = fopen("./procAnalysis/proc6.txt","a");
  fprintf(fp,"proc = %d , pc = %d, page = %d \n", proctmp, pc, page);
  fclose(fp);
}
if(proctmp == 7)
{
  fp = fopen("./procAnalysis/proc7.txt","a");
  fprintf(fp,"proc = %d , pc = %d, page = %d \n", proctmp, pc, page);
  fclose(fp);
}
if(proctmp == 8)
{
  fp = fopen("./procAnalysis/proc8.txt","a");
  fprintf(fp,"proc = %d , pc = %d, page = %d \n", proctmp, pc, page);
  fclose(fp);
}
if(proctmp == 9)
{
  fp = fopen("./procAnalysis/proc9.txt","a");
  fprintf(fp,"proc = %d , pc = %d, page = %d \n", proctmp, pc, page);
  fclose(fp);
}
if(proctmp == 10)
{
  fp = fopen("./procAnalysis/proc10.txt","a");
  fprintf(fp,"proc = %d , pc = %d, page = %d \n", proctmp, pc, page);
  fclose(fp);
}
if(proctmp == 11)
{
  fp = fopen("./procAnalysis/proc11.txt","a");
  fprintf(fp,"proc = %d , pc = %d, page = %d \n", proctmp, pc, page);
  fclose(fp);
}
if(proctmp == 12)
{
  fp = fopen("./procAnalysis/proc12.txt","a");
  fprintf(fp,"proc = %d , pc = %d, page = %d \n", proctmp, pc, page);
  fclose(fp);
}
if(proctmp == 13)
{
  fp = fopen("./procAnalysis/proc13.txt","a");
  fprintf(fp,"proc = %d , pc = %d, page = %d \n", proctmp, pc, page);
  fclose(fp);
}
if(proctmp == 14)
{
  fp = fopen("./procAnalysis/proc14.txt","a");
  fprintf(fp,"proc = %d , pc = %d, page = %d \n", proctmp, pc, page);
  fclose(fp);
}
if(proctmp == 15)
{
  fp = fopen("./procAnalysis/proc15.txt","a");
  fprintf(fp,"proc = %d , pc = %d, page = %d \n", proctmp, pc, page);
  fclose(fp);
}
if(proctmp == 16)
{
  fp = fopen("./procAnalysis/proc16.txt","a");
  fprintf(fp,"proc = %d , pc = %d, page = %d \n", proctmp, pc, page);
  fclose(fp);
}
if(proctmp == 17)
{
  fp = fopen("./procAnalysis/proc17.txt","a");
  fprintf(fp,"proc = %d , pc = %d, page = %d \n", proctmp, pc, page);
  fclose(fp);
}
if(proctmp == 18)
{
  fp = fopen("./procAnalysis/proc18.txt","a");
  fprintf(fp,"proc = %d , pc = %d, page = %d \n", proctmp, pc, page);
  fclose(fp);
}
if(proctmp == 19)
{
  fp = fopen("./procAnalysis/proc19.txt","a");
  fprintf(fp,"proc = %d , pc = %d, page = %d \n", proctmp, pc, page);
  fclose(fp);
}
